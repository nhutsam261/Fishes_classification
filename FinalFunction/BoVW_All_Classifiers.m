...
clear all
clc
addpath('D:\THIRD YEAR\Nh‚Ún daÚng m‚ﬁu\FishProject\FinalFunction');
addpath('D:\THIRD YEAR\Nh‚Ún daÚng m‚ﬁu\FishProject\Function');
imgFolder = fullfile('D:\THIRD YEAR\Nh‚Ún daÚng m‚ﬁu\FishProject\Segment');
...
ann=sum(diag(confmat))/sum(confmat(:));
maxANN=max(maxANN,ann);
disp(1-error);
end
